...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.POLARITY {ACTIVE_HIGH} \
 ] [get_bd_pins /kronos_v_0/sys_rst]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x40000000 [get_bd_addr_spaces kronos_v_0/bus_axi] [get_bd_addr_segs ring_buf_0/S00_AXI/S00_AXI_reg] SEG_ring_buf_0_S00_AXI_reg
